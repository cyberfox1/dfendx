...
uses Classes, Windows, Dialogs, Forms, SysUtils, ShellAPI, LanguageSetupUnit, CommonHelpers, System.UITypes;
...
procedure TRunPrgManager.InitTimer;
begin
...
begin
  ...
  If DuplicateHandle(GetCurrentProcess,AHandle,GetCurrentProcess,@NewHandle,0,False,DUPLICATE_SAME_ACCESS)
    then List[I].WaitHandle:=NewHandle
    else List[I].WaitHandle:=INVALID_HANDLE_VALUE;
end;
