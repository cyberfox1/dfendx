...
uses Registry, Math, CommonHelpers, CommonTools, LanguageSetupUnit, VistaToolsUnit, HelpConsts,
     PrgSetupUnit, IconLoaderUnit, PrgConsts, MainUnit, LoggingUnit, DOSBoxLangTools, System.UITypes,
     DOSBoxUnitHelpers, GameDBToolsHelpers;
...
begin
  ...
  { Auto-update offer removed from first-run wizard (product does not push updates from here). }
...
begin
  ...
  try
    ...
    try
      ...
      If Reg.OpenKey('\Software\DFendX',False) and Reg.ValueExists('Installer Language') then begin
