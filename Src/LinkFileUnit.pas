...
uses Windows, SysUtils, Forms, ShellAPI, Math, PrgSetupUnit, CommonHelpers, CommonTools,
     LanguageSetupUnit, LinkFileEditFormUnit, PrgConsts, LinkFileHelpers;
...
begin
  if LoadLinkFileData(FFileNameOnly, PrgDataDir, PrgDir, FDataNames, FDataLinks) then
    FChanged := False;
end;
