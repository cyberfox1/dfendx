...
uses Windows, SysUtils, Dialogs, IniFiles, Xml.XMLIntf, Xml.Win.msxmldom, CommonHelpers, CommonTools,
     HashCalc, PackageDBToolsUnit, LanguageSetupUnit, GameDBToolsUnit,
      PrgConsts, ZipInfoFormUnit, ZipPackageUnit, System.UITypes,
      PackageBuilderHelpers;
...
begin
  ...
  Result := GetNormalLastFileVersion(I div 65536, I mod 65536, J div 65536);
end;
...
begin
  ...
  try
    result.DOMVendor:=Xml.Win.msxmldom.MSXML_DOM;
    result.Active:=True;
  except
