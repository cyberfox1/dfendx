...
uses ShlObj, Math, LanguageSetupUnit, VistaToolsUnit, IconManagerFormUnit,
     PrgSetupUnit, PrgConsts, CommonHelpers, CommonTools, GameDBToolsUnit, ScummVMToolsUnit,
     ExtraExeEditFormUnit, HelpConsts, ZipFormHelpers, ZipInfoFormUnit, IconLoaderUnit,
     ImageStretch, DOSBoxUnit, System.UITypes;
