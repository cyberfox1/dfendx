...
uses ShellAPI, IniFiles, Math, PackageDBToolsUnit, CommonHelpers, CommonTools, PrgConsts,
     ...
     ClassExtensions, System.Types, System.UITypes,
     FileNameHelpers;
...
begin
  result := FileNameHelpers.FileNameOnly(S);
end;
