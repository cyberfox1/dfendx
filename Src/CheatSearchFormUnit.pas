...
uses
  ...
  Dialogs, ExtCtrls, StdCtrls, Buttons, CheatDBSearchUnit, CheatDBHelpers, CheatDBUnit;
...
uses CommonHelpers, CommonTools, VistaToolsUnit, LanguageSetupUnit, IconLoaderUnit, HelpConsts,
     PrgSetupUnit, CheatDBToolsUnit, StatisticsFormUnit, System.UITypes;
