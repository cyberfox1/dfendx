...
uses ShlObj, VistaToolsUnit, LanguageSetupUnit, CommonHelpers, CommonTools, PrgConsts,
     WaitFormUnit, GameDBToolsUnit, SmallWaitFormUnit, UninstallFormUnit,
     HelpConsts, IconLoaderUnit, System.Types, System.UITypes;
...
begin
  ...
  If OpMode=omUserDir then begin
    S:=IncludeTrailingPathDelimiter(GetSpecialFolder(0,CSIDL_PROFILE))+'DFendX\';
  end else begin
