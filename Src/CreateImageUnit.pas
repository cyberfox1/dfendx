...
uses ShellAPI, VistaToolsUnit, LanguageSetupUnit, PrgSetupUnit, CommonHelpers, CommonTools,
     PrgConsts, ImageTools, HelpConsts, IconLoaderUnit, CreateImageToolsUnit,
     CreateISOImageFormUnit, System.UITypes;
...
begin
  HDGeometryEdit.Text:='';
  try
    HDGeometryEdit.Text:=GetGeometryFromMB(StrToInt(HDSizeEdit.Text));
  except
    exit;
  end;
end;
