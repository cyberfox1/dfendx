...
uses ShellAPI, LanguageSetupUnit, VistaToolsUnit, PrgSetupUnit, CommonHelpers,
     HelpConsts;
...
begin
  ...
  PrgSetup.AllowPixelShader:=True;
  If ValueChanged[3] then begin
    GameDB.ConfOpt.Scale:=DefaultValueChange(GameDB.ConfOpt.Scale,'Hardware 2x (hardware2x)',True);
    GameDB.ConfOpt.Scale:=DefaultValueChange(GameDB.ConfOpt.Scale,'Hardware 3x (hardware3x)',True);
  end;
