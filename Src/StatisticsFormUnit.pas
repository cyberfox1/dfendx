...
uses VistaToolsUnit, LanguageSetupUnit, CommonHelpers, CommonTools, PrgSetupUnit, PrgConsts,
...
Var TemplateDB : TGameDB;
    ...
    S : String;
begin
  St.Add('DFendX '+GetFileVersionAsString);
  St.Add('');
  ...
  TemplateDB:=TGameDB.Create(PrgDataDir+AutoSetupSubDir,gbtAutoSetupDB,False);
  try
