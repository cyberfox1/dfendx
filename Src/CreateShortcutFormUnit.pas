...
uses ShlObj, VistaToolsUnit, LanguageSetupUnit, CommonHelpers, CommonTools, PrgSetupUnit,
     PrgConsts, GameDBToolsUnit, GameDBToolsHelpers, GameDBHelpers, DosBoxUnit, HelpConsts, IconLoaderUnit, System.UITypes;
