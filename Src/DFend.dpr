...
uses
  ...
  CommonHelpers in 'CommonHelpers.pas',
  ...
  ConfOptDefaults in 'ConfOptDefaults.pas',
  VistaToolsUnit in 'VistaToolsUnit.pas',
  GameDBUnit in 'GameDBUnit.pas',
  GameDBToolsHelpers in 'GameDBToolsHelpers.pas',
  ...
  DosBoxConfUnit in 'DosBoxConfUnit.pas',
  ...
  ExoDOSDBUnit in 'ExoDOSDBUnit.pas',
  SetupFrameExoDOSUnit in 'SetupFrameExoDOSUnit.pas' {SetupFrameExoDOS: TFrame},
  ...
  HelpContextMap in 'HelpContextMap.pas',
  ...
  ScreenshotPaneFormUnit in 'ScreenshotPaneFormUnit.pas' {ScreenshotPaneForm},
  ...
  DataReaderThreadsUnit in 'DataReaderThreadsUnit.pas',
...
//{$IFDEF DEBUG}
//  DiagnosticsUnits in '..\LocalSrc\DiagnosticsUnits.pas',
//{$ENDIF}
  ...
  FireDACSilentUnit in 'FireDACSilentUnit.pas',
  ScreenshotsDBUnit in 'ScreenshotsDBUnit.pas',
  NewScreenshotsCacheUnit in 'NewScreenshotsCacheUnit.pas',
  DataReaderBaseUnit in 'DataReaderBaseUnit.pas',
  DataReaderTheGamesDBUnit in 'DataReaderTheGamesDBUnit.pas',
  DataReaderExoDOSUnit in 'DataReaderExoDOSUnit.pas',
  ToggleSwitchExUnit in 'ToggleSwitchExUnit.pas';

{$R *.res}
{ Version from Version.rc — Project Options "Include version information" must be OFF
  so DFend.res does not also embed a conflicting VERSIONINFO (was stamping 1.0.0). }
...
begin
  ...
  Application.Title := 'DFendX';
  { Icons: Src\*.res from Src\*.rc; art Install\IconSources\; IconSets\ via Install\BuildIconAssetsRes.bat }
