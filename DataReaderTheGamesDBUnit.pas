...
uses SysUtils, Math, Xml.XMLDom, Xml.XMLDoc, Xml.Win.msxmldom, ActiveX, PrgSetupUnit,
     CommonHelpers, CommonTools, PrgConsts, InternetDataWaitFormUnit, DataReaderToolsUnit,
     PackageDBToolsUnit;
...
Var Id, URL, TempFile : String;
    ...
    S : String;
    St : TStringList;
    Genre, Developer, Publisher, Year, Notes, ImagePageURL : String;
begin
  result:=False;
  Meta:=nil;
