...
LangString LANGNAME_ConfirmDelPrgDir ${LANG_DANISH} "There are some files not created by the DFendX installer in the installation directory. Do you want to remove the folder $INSTDIR anyway?" ; NEW
...
LangString LANGNAME_NotDFendXInstallation ${LANG_DANISH} "This folder is not a DFendX installation. Need DFend.dat, DFend.exe, Bin\dfxvalidator.exe, and a DFendX File Description on DFend.exe."
