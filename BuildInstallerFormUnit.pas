...
uses Registry, ShellAPI, VistaToolsUnit, LanguageSetupUnit, PrgSetupUnit,
     CommonHelpers, CommonTools, PrgConsts, GameDBToolsUnit, UninstallFormUnit, HelpConsts,
     IconLoaderUnit, System.Types, System.UITypes;
...
begin
  ...
  {Copy DFendX DataInstaller.nsi to PrgDataDir if missing}
