...
uses SysUtils, TypInfo, ShellAPI, CommonHelpers, CommonTools, VistaToolsUnit, LanguageSetupUnit, System.Types;
...
begin
  ...
  try
    ...
    try
      ...
      { ShortString class name: DFM layout is length-byte + 1-byte chars (ASCII only). }
...
const tkCopyProperties=[tkInteger, tkEnumeration, tkFloat, tkString, tkSet, tkClass, tkMethod, tkWString, tkUString, tkVariant, tkInterface, tkInt64, tkDynArray];
Var Count,I : Integer;
    PropInfos : PPropList;
    S : String;
begin
    ...
    For I:=0 to Count-1 do begin
      ...
      try
        Case PropInfos^[I]^.PropType^.Kind of
          ...
          tkWString,
          tkUString     : SetStrProp(NewControl,S,GetStrProp(OldControl,S));
