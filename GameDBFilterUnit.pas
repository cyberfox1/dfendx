...
uses SysUtils, CommonHelpers, GameDBFilterToolsUnit, LanguageSetupUnit;
...
begin
  Case FFilterType of
    ...
    ftNotes     : begin St:=StringToStringList(AGame.Notes); try result:=NotPrefix xor Compare(ExtUpperCase(St.Text)); finally St.Free; end; end;
